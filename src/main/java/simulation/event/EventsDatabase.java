...
public class EventsDatabase
{
	...
	public EventsDatabase()
	{
		weekendEvents = Arrays.asList(
				...
				new WeekendEvent("Poznanie ziomka z wyższego roku, który potrzebuje pomocy z programem, dzięki czemu simulation.student zdobywa nowe umiejętności.", StatisticType.Inteligencja, 4),
				...
				new WeekendEvent("Impreza na Wyspie. Znowu simulation.student nie uczy się a imprezuje.", StatisticType.Lenistwo, 10),
				...
				new WeekendEvent("Szukając opracowań na internecie simulation.student.Student pobiera wirusa. Jeśli podstępem go nie wyizoluje skończy bez komputera na 2 dni.", StatisticType.Spryt, 6),
				new WeekendEvent("Zamiast się uczyć simulation.student.Student gra cały dzień w grę.", StatisticType.Lenistwo, 10)
				);
